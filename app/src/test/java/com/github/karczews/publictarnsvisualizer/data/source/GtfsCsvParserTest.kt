...
class GtfsCsvParserTest {
    ...
    fun `parseStopTimesStreaming parses time fields`() {
        ...
        val results = mutableListOf<com.github.karczews.publictarnsvisualizer.data.db.entity.StopTimeEntity>()
    ...
    fun `parseShapesStreaming parses coordinates`() {
        ...
        val results = mutableListOf<com.github.karczews.publictarnsvisualizer.data.db.entity.ShapePointEntity>()
